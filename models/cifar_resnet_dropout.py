...
# and the dropout implementation from: https://github.com/KellerJordan/ResNet-PyTorch-CIFAR10/blob/master/model.py
...
class CIFARResNetDropout(nn.Module):
    ...
    class Block(nn.Module):
        ...
        def __init__(self, f_in, f_out, downsample, builder, last_block):
            super(CIFARResNetDropout.Block, self).__init__()
            ...
            self.dropout = nn.Dropout(p=pargs.dropout, inplace=True)
    ...
    def __init__(self):
        super(CIFARResNetDropout, self).__init__()
        builder = Builder()
