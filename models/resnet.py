...
def ResNet18(pretrained=False):
    return ResNet(Builder(), BasicBlock, [2, 2, 2, 2], args.output_size)


def ResNet50(pretrained=False):
    return ResNet(Builder(), Bottleneck, [3, 4, 6, 3], args.output_size)


def ResNet101(pretrained=False):
    return ResNet(Builder(), Bottleneck, [3, 4, 23, 3], args.output_size)
